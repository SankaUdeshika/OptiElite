...
//            Delete From Invoice 
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (tableRow == -1) {
            JOptionPane.showMessageDialog(this, "Please Select a Order", "ERROR", JOptionPane.ERROR_MESSAGE);
        } else {
    ...
    private void jToggleButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton2ActionPerformed
        // TODO add your handling code here:
        if (jTable1.getSelectedRow() != -1) {
            BroadCastMessageSystem bms = new BroadCastMessageSystem(String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 2)));
            bms.setVisible(true);
        }
