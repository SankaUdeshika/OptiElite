 ...
 * @author sanka
 */
public class TypeLensCortinChange extends javax.swing.JFrame {

    /**
     * Creates new form TypeLensCortinChange
     */
    LensStockAdding parentObject;

    public TypeLensCortinChange(LensStockAdding object) {
        initComponents();
        loadLensCortin();
        parentObject = object;
    }
...
//            aniwaren Login wenna wenawa
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Lens Cortin");

        jLabel3.setText("Lens Coritin");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // Lens Brand Add
        String LensCortin = jTextField1.getText();

        if (LensCortin.isEmpty()) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (row == -1) {
            JOptionPane.showMessageDialog(this, "please Select a Lens Corint Row In Table", "Error", JOptionPane.ERROR_MESSAGE);
        } else {
            String lensID = String.valueOf(jTable1.getValueAt(row, 0));
            try {
                ResultSet rs = MySQL.execute("SELECT * FROM `invoice_coating` WHERE `coating_l_coating_id` = '" + lensID + "' ");
                if (rs.next()) {
                    JOptionPane.showMessageDialog(this, "Cant't Delete this Lens Corting. Contact Developer", "Error", JOptionPane.ERROR_MESSAGE);
                } else {
                    MySQL.execute("DELETE FROM `coating` WHERE `l_coating_id` = '" + lensID + "' ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TypeLensCortinChange.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
