 ...
 * @author sanka
 */
public class TypeLensDesignChange extends javax.swing.JFrame {

    /**
     * Creates new form TypeLensDesignChange
     */
    
    OrderMaking parentObject;
    
    public TypeLensDesignChange(OrderMaking object) {
        initComponents();
        loadLensDesign();
        parentObject = object;
    }
...
//            aniwaren Login wenna wenawa
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Lens Design");

        jLabel3.setText("Lens Design");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // Lens Brand Add
        String LensDesign = jTextField1.getText();

        if (LensDesign.isEmpty()) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (row == -1) {
            JOptionPane.showMessageDialog(this, "please Select a Lens Design Row In Table", "Error", JOptionPane.ERROR_MESSAGE);
        } else {
            String lensID = String.valueOf(jTable1.getValueAt(row, 0));
            try {
                ResultSet rs = MySQL.execute("SELECT * FROM `invoice_design` WHERE `design_l_design_id` = '" + lensID + "' ");
                if (rs.next()) {
                    JOptionPane.showMessageDialog(this, "Cant't Delete this Lens Design. Contact Developer", "Error", JOptionPane.ERROR_MESSAGE);
                } else {
                    MySQL.execute("DELETE FROM `design` WHERE `l_design_id` = '" + lensID + "' ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TypeLensDesignChange.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
